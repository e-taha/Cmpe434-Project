...
class PRM:
    def __init__(self, start, goal, obstacles, robot_radius):
        self.start = start
        self.goal = goal
    ...
    def plan(self):
        return prm_planning(self.start[0], self.start[1],
                            self.goal[0], self.goal[1],
                            [obs[0] for obs in self.obstacles],
                            [obs[1] for obs in self.obstacles],
                            self.robot_radius)
